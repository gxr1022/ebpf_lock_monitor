...
parser.add_argument("--time", help="Time in seconds to monitor locks in kernel Default Value is 180",
...
for lock in locks:
    ...
    b.attach_kretprobe(event=lock['lock_func'], fn_name="release_%s" % lock['name']) # unlock is better
